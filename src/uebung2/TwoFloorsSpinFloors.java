...
public class TwoFloorsSpinFloors extends JFrame implements GLEventListener {
	...
	public TwoFloorsSpinFloors() {
		setTitle("HW 2 a - spin two floors");
		setSize(600, 400);
		setLocation(200, 200);
	...
	public void display(GLAutoDrawable drawable) {
		...
		mvStack.rotate(rotateDeg/3, 0.0, 0.0, 1);
		mvStack.rotate(rotateDeg * 3, 0.0, 1, 0.0);
		...
		mvStack.rotate(-rotateDeg, 0.0, 1, 0.0);
		mvStack.rotate(rotateDeg/2, 0.0, 0.0, 1);
		mvStack.rotate(rotateDeg * 4, 0.0, 1, 0.0);
