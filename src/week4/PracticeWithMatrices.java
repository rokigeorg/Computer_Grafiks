...
public class PracticeWithMatrices extends JFrame implements GLEventListener{
...
public PracticeWithMatrices(){
  setTitle("Week 4 - draw 2 points different colors");
  setSize(600, 400);
  setLocation(200, 200);
