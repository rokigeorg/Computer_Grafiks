...
public class TriangleZoomInOut extends JFrame implements GLEventListener {
	...
	public TriangleZoomInOut() {
		
		setTitle("HW 5 - rotate triangle and zoom in and out");
		setSize(400, 400);
		setLocation(200, 200);
