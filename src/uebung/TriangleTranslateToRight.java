...
public class TriangleTranslateToRight extends JFrame implements GLEventListener {
	...
	public TriangleTranslateToRight() {
		setTitle("HW 2a  - translate a triangle to the right");
		setSize(600, 400);
		setLocation(200, 200);
	...
	public void display(GLAutoDrawable drawable) {
		...
		double transDeg = (double) 0.5;
		mMat.translate(transDeg, 0.0, 0.0);
