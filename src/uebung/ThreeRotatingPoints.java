...
public class ThreeRotatingPoints extends JFrame implements GLEventListener  {
	...
	public ThreeRotatingPoints() {
		setTitle("HW 3 - draw 3 points in diff colors and rotate ");
		setSize(600, 400);
		setLocation(200, 200);
