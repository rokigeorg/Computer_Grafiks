...
public class CubeDifferentColors extends JFrame implements GLEventListener {
	...
	public CubeDifferentColors() {
		setTitle("Week 6 - draw Qube different colors");
		setSize(600, 400);
		setLocation(200, 200);
